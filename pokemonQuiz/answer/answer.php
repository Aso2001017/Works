...
<body>
    ...
    <div class="profile">
        ...
        <button class="japanese"  onclick="japaneseButtonClick()"><img src="img/Japanese.png" alt="" class="monster-ball"></button>
        <button class="english" onclick="englishButtonClick()"><img src="img/English.png" alt="" class="master-ball"></button>
    ...
    <div class="nextBall">
        ...
        <form action="http://aso2001017.babyblue.jp/pokemonQuiz/question/question.php" method="post" id="Next">
            <input type ="image" name="submit" src="./img/next.png" alt=" 送信" id="nextBall1">
        </form>
        ...
        <form action="http://aso2001017.babyblue.jp/pokemonQuiz/lookover/lookover.php" method="post" id="Result" hidden>
            ...
            <input type ="image" name="submit" src="./img/exit.png" alt=" 送信" id="nextBall2" onclick="setTimeout(()=>disabled=true,0)">
        </form>
