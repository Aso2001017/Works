...
?>
    ...
    <div id="silhouetteArea">
        <div id="square">
            ...
            <img src="./img/モンスターボール.png" id="ball1">
            <img src="./img/モンスターボール.png" id="ball2">
            <img src="./img/モンスターボール.png" id="ball3">
            <img src="./img/モンスターボール.png" id="ball4">
        </div>
    </div>
    ...
    <div id="answerArea">
        <p id="text">？？？？</p>
        <form action="	http://aso2001017.babyblue.jp/pokemonQuiz/answer/answer.php" method="post" name="form1" >
            ...
            <input type ="image" name="submit" src="./img/toAnswer.png" alt=" 送信" id="toAnswer" onclick="setTimeout(()=>disabled=true,0)">
    </div>
